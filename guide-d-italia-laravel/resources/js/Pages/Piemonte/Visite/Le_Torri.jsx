...
export default function Le_Torri(props) {
    return (
        <>
            <Head title="Le Torri"/>
            <AuthenticatedLayout
            ...
            >
                <main>
                    <div className='le_torri' style={{ position: 'relative' }}>
                        <h1 className='text-center' style={{ position: 'absolute', top: 20, left: 20 }}>Le Torri</h1>
                    ...
                    <div className='margin mb-4'>
                        ...
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1048.2986251744512!2d8.033867791588229!3d44.70111692467432!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x12d2b34327ec0069%3A0x490003b50faa7b08!2sTorre%20Astesiano!5e1!3m2!1sit!2sit!4v1722947662855!5m2!1sit!2sit"
                            width="600"
                            height="450"
                            style={{ border: 0 }}
                            allowFullScreen=""
