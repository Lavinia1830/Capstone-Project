...
export default function Duomo_di_San_Giovanni(props) {
  return (
    <>
        <Head title="Duomo di San Giovanni"/>
        <AuthenticatedLayout
        auth={props.auth}
        errors={props.errors}
        >
            <main>
                ...
                <div className="margin mt-3">
                    ...
                    <p>
                        <b>La Cappella del Duomo di Torino</b>, a pianta interna circolare, opera del Guarini, fu commissionata da Emanuele Filiberto di Savoia per conservare il sacro lenzuolo. Al centro della Cappella sorge l’altare, di fattura barocca come quest’ultima ed opera di Antonio Bertola. 
                        Conserva al suo interno, in una teca di vetro e argento, la Sindone.
                    </p>
                    <p>
                        <b>All’esterno del Duomo si può notare il campanile</b>, costruito nel 1468, e che nei lavori di ampliamento nel Seicento non venne toccato. Voluto dal vescovo Giovanni di Compeys, il campanile, a tre ordini e munito di cella campanaria, ha subito alcune modifiche, soprattutto 
                        in altezza, durante il regno di Vittorio Amedeo II.
                    </p>
                    <p>
                        La facciata e gli interni del Duomo furono restaurati dopo <b>l’incendio avvenuto nella notte tra l’11 e il 12 Aprile del 1997</b> che ne aveva distrutto una buona parte. In quella occasione la Sindone fu salvata dal lavoro dei vigili del fuoco; ricordiamo tutti le immagini della 
                    ...
                    <p>
                        Sulla parete opposta all’altare maggiore, è possibile ammirare una <b>copia dell’Ultima Cena di Leonardo Da Vinci</b>. Si tratta di un dipinto davvero imponente di circa 900 kg commissionata nel 1835 dal Re Carlo Felice e realizzata in olio su legno dal pittore vercellese Luigi Cagna.
                    </p>
                </div>
