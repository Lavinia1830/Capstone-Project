    ...
    >
        <main>
            ...
            <div className="margin mt-3">
                ...
                <p>
                    Lungo le rive del fiume Po, uno dei parchi più antichi di <Link href='/destinazioni/torino' className='color_link'>Torino</Link> dove godersi aria fresca, passeggiare all’aperto, a piedi o in bicicletta, lontani dal caos cittadino. Il parco vanta un notevole patrimonio 
                    floristico e arboreo, con circa 1800 alberi ad alto fusto e una ricca avifauna, con tante specie di uccelli locali che ben si adattano all’habitat fluviale come aironi e germani reali. Non solo natura, all’interno dell’area verde si trova il Borgo Medievale realizzato 
                    per valorizzare e diffondere le antiche tradizioni storiche e culturali piemontesi, abitazioni, vie e statue tra cui quelle dedicate a Massimo D’Azeglio e Cesare Battisti, fontane come la Fontana dei dodici mesi con una grande vasca in stile rococò, e il caratteristico 
