...
export default function L_Hercole_Colosso(props) {
    return (
        <>
            <Head title="L'Hercole Colosso"/>
            <AuthenticatedLayout
                auth={props.auth}
                errors={props.errors}
            >
                <main>
                    <div className='l_hercole_colosso' style={{ position: 'relative' }}>
                    ...
                    <div className="margin mt-3">
                        <p className='fst-italic text-center'>
                            La monumentale statua in marmo bianco dell’Hercole Colosso, l’ultima opera esistente originale della Venaria Reale che si conosca, è ora ricollocata al centro della Fontana dell’Ercole
                        </p>
                    </div>
                    <div className='margin mt-3'>
                        <p>
                            Restaurata grazie al prezioso intervento della Consulta per la Valorizzazione dei Beni Artistici e Culturali di Torino, l’opera è tornata alla Reggia di Venaria dopo lunghe e complesse vicissitudini che l’hanno portata per molto tempo alla Villa del Capriglio e poi nei magazzini di Palazzo Madama, fino 
                            all’importante recupero che la restituisce al suo luogo d’origine.
                        </p>
                    </div>
                    <div className="margin mt-3">
                        <h2 className="color-subtitle">La statua dell'Ercole</h2>
                        <p>
