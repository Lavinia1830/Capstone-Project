    ...
    >
        <main>
            ...
            <div className="margin mt-3">
                <h2 className='text-center' style={{color:'#bdc667'}}>
                ...
                <p>
                    <b>L’edificio monumentale, vanta alcune delle più alte espressioni del barocco universale</b>: l'incantevole scenario della <b>Sala di Diana</b> progettata da Amedeo di Castellamonte, la solennità della <b>Galleria Grande</b> e della <b>Cappella di Sant’Uberto</b> 
                    con l’immenso complesso delle <b>Scuderie Juvarriane</b>, opere settecentesche di Filippo Juvarra, le fastose decorazioni, la spettacolare <b>Fontana del Cervo</b> nella Corte d’onore rappresentano la cornice ideale del <Link href='' className='text-decoration-none 
                    color_link'>Teatro di Storia e Magnificenza</Link>, il percorso espositivo dedicato ai Savoia che accompagna il visitatore lungo quasi 2.000 metri, tra piano interrato e piano nobile della Reggia.
                </p>
                <h3 className='fst-italic text-center' style={{color:'#bdc667'}}>La Reggia di Venaria raccoglie al suo interno un lungo percorso di visita attraverso le sue maestose sale, diversi poli espositivi per mostre temporanee e importanti opere di arte contemporanea</h3>
            </div>
