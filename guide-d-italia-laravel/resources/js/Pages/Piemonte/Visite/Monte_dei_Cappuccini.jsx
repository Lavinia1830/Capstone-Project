                ...
                <main>
                    ...
                    <div className="margin mt-3">
                        <p>
                            ...
                            del <Link href='/visite/piemonte/torino/ponte_vittorio_emanuele_i' className='text-decoration-none color_link'>Ponte Vittorio Emanuele I</Link>, che dà accesso a Piazza Vittorio Veneto. Su di esso, si erge il convento e la chiesa tardo-rinascimentale, manierista, e con interni barocchi di Santa Maria al <strong>Monte dei Cappuccini</strong> affidati ai frati 
                            Cappuccini, da cui il nome.
                        </p>
                    </div>
                    <div className='margin mt-'>
