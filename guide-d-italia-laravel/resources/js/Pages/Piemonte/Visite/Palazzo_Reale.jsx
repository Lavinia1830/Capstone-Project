                        ...
                        <Card className='me-2 mb-2 carta-percorsi'>
                            <Link href="/visite/piemonte/torino/palazzo_reale/palazzo_reale_armeria_reale_e_cappella_della_sindone" className='text-decoration-none'>
                                ...
                                <Card.Body>
                                    ...
                                    <Link className='text-decoration-none' href="/visite/piemonte/torino/palazzo_reale/palazzo_reale_armeria_reale_e_cappella_della_sindone"><button  className='btn-card position-absolute bottom-0 end-0 me-2 mb-1'>leggi tutto</button></Link>
                                </Card.Body>
                            </Link>
                        </Card>
                        <Card className='me-2 mb-2 carta-percorsi'>
                            <Link href="/visite/piemonte/torino/palazzo_reale/visita_archeologica" className='text-decoration-none'>
                                ...
                                <Card.Body>
                                    ...
                                    <Link className='text-decoration-none' href="/visite/piemonte/torino/palazzo_reale/visita_archeologica"><button  className='btn-card position-absolute bottom-0 end-0 me-2 mb-1'>leggi tutto</button></Link>
                                </Card.Body>
                            </Link>
                        </Card>
                        <Card className='me-2 mb-2 carta-percorsi'>
                            <Link href="/visite/piemonte/torino/palazzo_reale/capolavori_della_pittura" className='text-decoration-none'>
                                ...
                                <Card.Body>
                                    ...
                                    <Link className='text-decoration-none' href="/visite/piemonte/torino/palazzo_reale/capolavori_della_pittura"><button  className='btn-card position-absolute bottom-0 end-0 me-2 mb-1'>leggi tutto</button></Link>
                                </Card.Body>
                            </Link>
                        </Card>
                        <Card className='me-2 mb-2 carta-percorsi'>
                            <Link href="/visite/piemonte/torino/palazzo_reale/visita_completa" className='text-decoration-none'>
                                ...
                                <Card.Body>
                                    ...
                                    <Link className='text-decoration-none' href="/visite/piemonte/torino/palazzo_reale/visita_completa"><button  className='btn-card position-absolute bottom-0 end-0 me-2 mb-1'>leggi tutto</button></Link>
                                </Card.Body>
                            </Link>
                        </Card>
                        <Card className='me-2 mb-2 carta-percorsi'>
                            <Link href="/visite/piemonte/torino/palazzo_reale/visita_ai_giardini" className='text-decoration-none'>
                                ...
                                <Card.Body>
                                    ...
                                    <Link className='text-decoration-none' href="/visite/piemonte/torino/palazzo_reale/visita_ai_giardini"><button  className='btn-card position-absolute bottom-0 end-0 me-2 mb-1'>leggi tutto</button></Link>
                                </Card.Body>
                            </Link>
                        </Card>
                        <Card className='me-2 mb-2 carta-percorsi'>
                            ...
                            <Card.Body>
                                <Card.Text className='mb-5 text-dark'>
                                    ...
                                    per entrare poco dopo nella spettacolare Armeria Reale, allestita con armi e armature antiche, cavalli e pennacchi, elmi e spade. Il percorso procede nella Galleria del Daniel, interamente affrescata e rivestita di 
                                    Specchi, per passare nella scenografica Sala da Pranzo e nella Sala da Ballo, ricca di cristalli e dorature. Termina nella Cappella della Sindone, che stupisce per dimensioni e luminosità. Lungo il percorso sono 
                                    presenti dei QR-code per ascoltare le tracce audio pensate per i giovanissimi visitatori, per un’esperienza di visita coinvolgente e divertente!
                                </Card.Text> 
                            </Card.Body>
                        </Card>
                        <Card className='me-2 mb-2 carta-percorsi'>
                            ...
                            <Card.Body>
                                <Card.Text className='mb-5 text-dark'>
                                    ...
                                    diversi. Oltre alle immagini sacre, che hanno per protagonisti la Maria, Gesù, i santi e gli angeli, nei dipinti si trovano rappresentati miti dell’antichità, scene di vita quotidiana e ritratti di persone realmente 
                                    vissute, oltre a nature morte e paesaggi. La visita può essere arricchita leggendo gli approfondimenti dedicati ai più piccoli, oppure ascoltando le voci dei personaggi dall’Audioguida Junior, o ancora giocando con 
                                    l’app che porta alla pacifica conquista delle sale del primo piano.
                                </Card.Text> 
                            </Card.Body>
                        </Card>
                        <Card className='me-2 mb-2 carta-percorsi'>
                            ...
                            <Card.Body>
                                <Card.Text className='mb-5 text-dark'>
                                    ...
                                    della Pace</b> di Jan Miel nella Sala del Trono, gli <b>Enigmi</b> che decorano il fregio della Sala delle Udienze Private e il <b>Sonno di Annibale</b> che campeggia al centro della monumentale copertura lignea del 
                                    soffitto della Sala del Consiglio. Il percorso si arricchisce della volta affrescata a fine Seicento da Daniel Seiter nell’omonima galleria e procede poi nella sfarzosa Sala dell’Alcova, costruita e decorata negli anni 
                                    Sessanta in occasione delle nozze tra Carlo Emanuele II e Francesca d’Orléans. Al termine del percorso che si snoda all’interno del Palazzo Reale, si accede alla Cappella della Sindone, universalmente riconosciuta come 
                                    vertice dell’architettura barocca, costruita a partire dal 1668 e progettata dal matematico Guarino Guarini, geniale mente dell’ordine Teatino a servizio dei Duchi di Savoia. Procedendo nella Galleria Sabauda il Seicento 
                                    è ben rappresentato delle opere dei pittori Caravaggeschi, tra le quali ricordiamo una raffinata <b>Annunciazione</b> di Orazio Gentileschi e il <b>Suonatore di Tiorba</b> di Antiveduto Gramatica.
                                </Card.Text> 
                            </Card.Body>
                        </Card>
                        <Card className='me-2 mb-2 carta-percorsi'>
                            ...
                            <Card.Body>
                                <Card.Text className='mb-5 text-dark'>
                                    ...
                                    nell’Ottocento dal maestro Giuseppe Gaggini, mentre ai quattro angoli dell’Armeria Reale sono disposte le sculture allegoriche dei Fratelli Collino. Nella Sala dei Medaglioni si incontrano quattro grandi rilievi marmorei 
                                    scolpiti nel Settecento da Simone Martinez, autore anche della fontana del Giardino di Levante, contornata da sculture di epoche differenti e provenienti da altre residenze. Il percorso si snoda inoltre nelle sale del Museo 
                                    di Antichità, dove sono esposte sculture e rilievi di epoca assira, fenicia, greca, etrusca e romana.
                                </Card.Text> 
                            </Card.Body>
                        </Card>
                    </div>
