...
export default function Duomo_S_Maria_Assunta(props) {
    return (
        <>
            <Head title="Duomo di S. Maria Assunta"/>
            <AuthenticatedLayout
                auth={props.auth}
                errors={props.errors}
            >
                <main>
                    <div className='duomo_s_maria_assunta' style={{ position: 'relative' }}>
                        <h1 className='text-center' style={{ position: 'absolute', top: 20, left: 20 }}>Duomo di S. Maria Assunta</h1>
                    ...
                    <div className='margin mb-4'>
                        ...
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d633.0304999529922!2d7.87485987832715!3d45.468073628304104!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x478884b89120e453%3A0x8fd7768867a1c0ef!2sCattedrale%20di%20Santa%20Maria%20Assunta!5e1!3m2!1sit!2sit!4v1716646728713!5m2!1sit!2sit"
                            width="600"
                            height="450"
                            style={{ border: 0 }}
                            allowFullScreen=""
