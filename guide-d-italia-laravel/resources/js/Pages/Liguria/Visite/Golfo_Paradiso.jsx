    ...
    >
        <main>
            ...
            <div className="margin mt-3">
                ...
                <p>
                    Ci sono luoghi che racchiudono nel proprio nome la propria storia e la propria indiscutibile bellezza. <strong>Golfo Paradiso</strong> è uno di questi. Questo tratto di costa compreso tra <Link href='/destinazioni/genova' className='text-decoration-none color_link'>Genova</Link> 
                    e il Monte di Portofino è un susseguirsi di piccole insenature, graziosi borghi e colline a picco sul mare blu di Liguria, una meta imperdibile per chiunque sia alla scoperta della <b>Riviera di Levante</b>.
                </p>
                <p>
                    Scoprite il Golfo Paradiso seguendo la <b>via Aurelia</b>, strada antichissima che attraversa tutta la Liguria. Si parte da <b>Nervi</b>, quartiere periferico di Genova vera e propria “terra di mezzo” tra la città e la Riviera. Raggiungete poi <b>Bogliasco</b>, borgo di 
                    marinai il cui ponte romano vi regalerà uno splendido scorcio panoramico sulle due rive del Rio Poggio. A <b>Pieve Ligure</b> perdetevi tra le strette <i>creuze</i> avvolti dal profumo delle mimose, a cui qui è dedicata anche una sagra. Arrivate così a <b>Sori</b>, che 
                    diede i natali agli antenati di Pablo Picasso, per poi fermarvi a <b>Recco</b> per una pausa golosa a base della caratteristica focaccia al formaggio.
                </p>
                <p>
