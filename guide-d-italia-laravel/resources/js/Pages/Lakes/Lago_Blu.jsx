            ...
            <main>
                ...
                <div className="margin mt-3">
                    ...
                    <p>
                        ...
                        tra il blu e il verde per via delle particolari alghe che crescono al suo interno. Nelle giornate limpide, nelle sue acque si specchia il <Link href='/montagna/valle_d_aosta/monte_cervino' className='text-decoration-none color_link'>Monte Cervino</Link>, maestoso e imponente.
                    </p>
                    <p>
                        ...
                        poco, potrete raggiungere il <Link href='/laghi/valle_d_aosta/lago_di_goillet' className='text-decoration-none color_link'>Lago Goillet</Link>, da cui godrete di una splendida vista su cime come il Colle del Teodulo, la Testa Grigia e la Dent d'Hérens.
                    </p>
                    <p>
                        Non dimenticate, poi, di gustare le <Link href='/enogastonomia/valle_d_aosta/specialità_tipiche_valdostane' className='text-decoration-none color_link'>specialità tipiche valdostane</Link>: vivamente consigliata è la <b>polenta concia</b>, vera prelibatezza della regione, preparata con burro 
                        e formaggi.
                    </p>
                </div>
