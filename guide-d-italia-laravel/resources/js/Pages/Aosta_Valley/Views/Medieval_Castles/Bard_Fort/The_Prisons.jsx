...
export default function The_Prisons(props) {

    const { t } = useTranslation();

    return (
        <>
            <Head title={t("the prisons")}/> 
            <AuthenticatedLayout
                auth={props.auth}
                errors={props.errors}
            >
                <main>
                    <div className='the_prisons' style={{ position: 'relative' }}>
                        <h1 style={{ position: 'absolute', top: 20, left: 20 }}>{t("the prisons")}</h1>
