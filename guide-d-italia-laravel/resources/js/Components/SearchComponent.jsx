...
export default function CercaComponent() {
  ...
  return (
    <div className="row" style={{paddingLeft:'30px'}}>
      <div>
        <h4 className='text-white'>{t("search")}</h4>
      ...
      {searched && (
        <>
          {searchResults.length > 0 ? (
            <div>
              <h4 className='text-white'>{t("search results")}</h4>
              <ul>
            ...
            <p className='text-white'>{t("no results found")}</p>
          )}
        </>
      )}
      ...
      <div className='d-flex justify-content-center'>
          <div className='col-4'>
          <h4 className='text-white'>Articoli recenti</h4>
          <ul className='ps-3'>
            <li>
              ...
              <p className="m-0 text-white">29 Maggio 2023</p>
            </li>
            <li>
              ...
              <p className="m-0 text-white">4 Maggio 2022</p>
            </li>
            <li>
              ...
              <p className="m-0 text-white">7 Marzo 2022</p>
            </li>
            <li>
              ...
              <p className="m-0 text-white">28 Gennaio 2022</p>
            </li>
            <li>
              ...
              <p className="m-0 text-white">9 Gennaio 2022</p>
            </li>
          </ul>
        </div>
        <div className='col-3'>
